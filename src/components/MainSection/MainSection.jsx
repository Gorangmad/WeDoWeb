  ...
  return (
    ...
    >
      <div className="w-full md:mt-10 lg:mt-0     flex justify-start lg:justify-center items-center">
        ...
        <p className="text-start lg:text-center text-4xl min-[600px]:text-[2.5rem] md:text-[3rem] lg:text-9xl  text-pretty   leading-relaxed  tracking-normal font-black min-[550px]:w-5/6 min-[700px]:w-3/4 md:w-5/6 min-[900px]:w-3/4 lg:w-2/3 xl:w-3/5   min-[1760px]:w-1/2">
